...
const environmentFile = `export const environment = {
  ...
  patient_wt: {
    apiUrl: '${process.env.PATIENT_WT_API_URL || 'http://localhost:3000'}'
  },
  ...
  role: '${process.env.ROLE || 'default-role'}',
  cookieDomain: '${process.env.COOKIE_DOMAIN || 'localhost'}',
  patient_nt_api_url: '${process.env.PATIENT_NT_API_URL || 'http://localhost:3000/graphql'}',
};
`;
...
console.log(
  '  - Patient ST API:',
  process.env.PATIENT_ST_API_URL || 'http://localhost:8080/graphql',
);
console.log(
  '  - Patient CT API:',
  process.env.PATIENT_CT_API_URL || 'http://localhost:8080/graphql',
);
